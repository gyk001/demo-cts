...
import cn.guoyukun.demo.cts.service.LorryService;
 ...
 */
@Controller
@RequestMapping("/lorry")
public class LorryController {
	//日志对象
	private static final Logger logger = LoggerFactory.getLogger(LorryController.class);
	...
	public Map<String,Object> list(HttpServletRequest req,
		...
		try{
			...
			final List<Map<String,Object>> list = lorryService.getList(page, rows, params);
			final long total = lorryService.getCount(params);
