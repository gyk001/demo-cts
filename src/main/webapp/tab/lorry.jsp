<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <%-- 引用页面自己的js和css --%>
        <script type="text/javascript" src="biz/lorry.js" charset="UTF-8"></script>
    </head>

    <body>
        <div id="toolbar">
			<label for="search_id">物流车编码:</label>
			<input type="text" class="combo-text" id="search_id" style="width: 90px;" />
