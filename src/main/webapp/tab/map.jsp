<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <%-- 引用页面自己的js和css --%>
        <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=pGbw9LXUaGvIsbqS0QEXGySE"></script>
        <script type="text/javascript" src="biz/map.js" charset="UTF-8"></script>
    ...
    <!-- 
        <div id="toolbar">
         ...
         -->
        <div id="allmap" class="easyui-panel" data-options="fit:true"></div>
    </body>
